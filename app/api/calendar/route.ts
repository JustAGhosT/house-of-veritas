...
const MOCK_EVENTS = [
  {
    ...
    end: { dateTime: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000 + 4 * 60 * 60 * 1000).toISOString() },
    status: 'confirmed',
    colorId: '2',
  },
  {
  ...
  },
  {
    ...
    end: { dateTime: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000 + 1 * 60 * 60 * 1000).toISOString() },
    status: 'confirmed',
    colorId: '7',
  },
  {
    ...
    end: { dateTime: new Date(Date.now() + 10 * 24 * 60 * 60 * 1000 + 1 * 60 * 60 * 1000).toISOString() },
    status: 'confirmed',
    colorId: '5',
  },
  {
...
export const POST = withAuth(async (request) => {
  try {
    ...
    if (allDay) {
      ...
      newEvent.end = { dateTime: end || new Date(new Date(start).getTime() + 60 * 60 * 1000).toISOString() }
    }
